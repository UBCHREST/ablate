...
if (NOT (DEFINED Kokkos_DIR|CACHE{Kokkos_DIR}|ENV{Kokkos_DIR}))
        ...
        ExternalProject_Add(Kokkos
                ...
                GIT_TAG 3.6.01
                PREFIX kokkos
                CMAKE_ARGS -DCMAKE_INSTALL_PREFIX:PATH=${CMAKE_BINARY_DIR}/kokkos/install
                CONFIGURE_HANDLED_BY_BUILD OFF
                )

        set(Kokkos_DIR "${CMAKE_BINARY_DIR}/kokkos/install")
        message(STATUS "Kokkos_DIR not set.  Building Kokkos and setting Kokkos_DIR: ${CMAKE_BINARY_DIR}/kokkos/install")
        add_dependencies(ablateLibrary Kokkos)
