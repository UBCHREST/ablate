...
#include "finiteVolume/lesCompressibleFlowSolver.hpp"
...
struct CompressibleFlowlesDiffusionTestParameters {
...
class CompressibleFlowlesDiffusionTestFixture : public testingResources::MpiTestFixture, public ::testing::WithParamInterface<CompressibleFlowlesDiffusionTestParameters> {
   public:
...
TEST_P(CompressibleFlowlesDiffusionTestFixture, ShouldConvergeToExactSolution) {
    StartWithMPI
        PetscErrorCode ierr;
        ...
        for (PetscInt l = 1; l <= GetParam().levels; l++) {
            ...
            auto flowObject = std::make_shared<ablate::finiteVolume::LesCompressibleFlowSolver>("testFlow",
...
INSTANTIATE_TEST_SUITE_P(CompressibleFlow, CompressibleFlowlesDiffusionTestFixture,
                         testing::Values((CompressibleFlowlesDiffusionTestParameters){.mpiTestParameter = {.testName = "ev diffusion mpi 1", .nproc = 1, .arguments = ""},
                                                                                      .parameters = {.L = 0.1, .diff = 1.0E-5, .rho = 1.0},
                                                                                      .initialNx = 3,
                                                                                      .levels = 3,
                                                                                      .expectedL2Convergence = {NAN, NAN, NAN, 2.2, 2.2},
                                                                                      .expectedLInfConvergence = {NAN, NAN, NAN, 2.2, 2.2}},
                                         (CompressibleFlowlesDiffusionTestParameters){.mpiTestParameter = {.testName = "ev diffusion mpi 1 density 2.0", .nproc = 1, .arguments = ""},
                                                                                      .parameters = {.L = 0.1, .diff = 1.0E-5, .rho = 2.0},
                                                                                      .initialNx = 3,
                                                                                      .levels = 3,
                                                                                      .expectedL2Convergence = {NAN, NAN, NAN, 2.2, 2.2},
                                                                                      .expectedLInfConvergence = {NAN, NAN, NAN, 2.2, 2.2}},
                                         (CompressibleFlowlesDiffusionTestParameters){.mpiTestParameter = {.testName = "ev diffusion mpi 2 density 2.0", .nproc = 2, .arguments = ""},
                                                                                      .parameters = {.L = 0.1, .diff = 1.0E-5, .rho = 2.0},
                                                                                      .initialNx = 3,
                                                                                      .levels = 3,
                                                                                      .expectedL2Convergence = {NAN, NAN, NAN, 2.2, 2.2},
                                                                                      .expectedLInfConvergence = {NAN, NAN, NAN, 2.2, 2.2}}),
                         [](const testing::TestParamInfo<CompressibleFlowlesDiffusionTestParameters>& info) { return info.param.mpiTestParameter.getTestName(); });
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
