...
INSTANTIATE_TEST_SUITE_P(
    PerfectGasEOSTests, PerfectGasTestCreateAndViewFixture,
    testing::Values((EOSTestCreateAndViewParameters){.options = {}, .species = {}, .expectedView = "EOS: perfectGas\n\tgamma: 1.4\n\tRgas: 287\n"},
                    (EOSTestCreateAndViewParameters){.options = {{"gamma", "3.2"}, {"Rgas", "100.2"}}, .species = {}, .expectedView = "EOS: perfectGas\n\tgamma: 3.2\n\tRgas: 100.2\n"},
                    (EOSTestCreateAndViewParameters){
                        .options = {{"gamma", "3.2"}, {"Rgas", "100.2"}}, .species = {"O2", "N2"}, .expectedView = "EOS: perfectGas\n\tgamma: 3.2\n\tRgas: 100.2\n\tspecies: O2, N2\n"}),
...
INSTANTIATE_TEST_SUITE_P(PerfectGasEOSTests, PGThermodynamicPropertyTestFixture,
                         testing::Values((PGTestParameters){.options = {{"gamma", "1.4"}, {"Rgas", "287.0"}},
                                                            ...
                                                            .fields = {ablateTesting::domain::MockField::Create("euler", 5, 0)},
...
INSTANTIATE_TEST_SUITE_P(PerfectGasEOSTests, PGFieldFunctionTestFixture,
                         testing::Values((PGFieldFunctionTestParameters){.options = {{"gamma", "1.4"}, {"Rgas", "287.0"}},
                                         ...
                                         (PGFieldFunctionTestParameters){.options = {{"gamma", "1.4"}, {"Rgas", "487.0"}},
                                                                         ...
                                                                         .property1Value = 101325.0,
                                                                         .property2Value = 1217500.0,
                                                                         .velocity = {10, 20},
                                                                         .yi = {},
                                                                         .expectedValue = {0.20805954825462011, 253364.51488706371, 2.080595482546201, 4.1611909650924019}},
                                         (PGFieldFunctionTestParameters){.options = {{"gamma", "1.4"}, {"Rgas", "487.0"}},
                                                                         .species = {},
                                                                         .field = "euler",
                                                                         ...
                                                                         .property1Value = 1217500.0,
                                                                         .property2Value = 101325.0,
                                                                         .velocity = {20, 10},
                                                                         .yi = {},
                                                                         .expectedValue = {0.20805954825462011, 253364.51488706371, 4.1611909650924019, 2.080595482546201}},
                                         (PGFieldFunctionTestParameters){.options = {{"gamma", "1.4"}, {"Rgas", "487.0"}},
                                                                         .species = {"H2", "O2", "N2"},
                                                                         .field = "densityYi",
                                                                         .property1 = ablate::eos::ThermodynamicProperty::Pressure,
                                                                         ...
                                                                         .velocity = {10, 20},
                                                                         .yi = {.1, .3, .6},
                                                                         .expectedValue = {0.20805954825462011 * .1, 0.20805954825462011 * .3, 0.20805954825462011 * .6}},
                                         (PGFieldFunctionTestParameters){.options = {{"gamma", "1.4"}, {"Rgas", "487.0"}},
                                                                         .species = {"H2", "O2", "N2"},
                                                                         .field = "densityYi",
                                                                         .property1 = ablate::eos::ThermodynamicProperty::InternalSensibleEnergy,
                                         ...
                                         (PGFieldFunctionTestParameters){.options = {{"gamma", "1.4"}, {"Rgas", "287.0"}},
                                                                         ...
                                                                         .property1Value = 1013250.0,
                                                                         .property2Value = 717500.0,
                                                                         .velocity = {10},
                                                                         .yi = {},
                                                                         .expectedValue = {3.5304878049, 3.5304878049 * 717550.0, 3.5304878049 * 10}},
                                         (PGFieldFunctionTestParameters){.options = {{"gamma", "1.4"}, {"Rgas", "287.0"}},
                                                                         .species = {},
                                                                         .field = "euler",
                                                                         .property1 = ablate::eos::ThermodynamicProperty::InternalSensibleEnergy,
