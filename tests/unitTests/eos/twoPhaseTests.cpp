...
INSTANTIATE_TEST_SUITE_P(TwoPhaseEOSTests, TwoPhaseTestCreateAndViewFixture,
                         testing::Values((TwoPhaseEOSTestCreateAndViewParameters){.eos1 = {}, .eos2 = {}, .expectedView = "EOS: twoPhase\n"},
                                         ...
                                         (TwoPhaseEOSTestCreateAndViewParameters){.eos1 = std::make_shared<ablate::eos::StiffenedGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "3.2"}, {"Cp", "100.2"},{"p0","9.9e5"}})),
                                                                  .eos2 = std::make_shared<ablate::eos::StiffenedGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "2.1"}, {"Cp", "204.7"},{"p0","3.5e6"}})),
                                                                  .expectedView = "EOS: twoPhase\nEOS: stiffenedGas\n\tgamma: 3.2\n\tCp: 100.2\n\tp0: 990000\nEOS: stiffenedGas\n\tgamma: 2.1\n\tCp: 204.7\n\tp0: 3.5e+06\n"},
                                         (TwoPhaseEOSTestCreateAndViewParameters){.eos1 = std::make_shared<ablate::eos::PerfectGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "1.4"}, {"Rgas", "287.0"}}), std::vector<std::string>{"O2","N2"}),
                                                                  .eos2 = std::make_shared<ablate::eos::PerfectGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "3.2"}, {"Rgas", "100.2"}}), std::vector<std::string>{"CO2","CO"}),
                                                                  .expectedView = "EOS: twoPhase\nEOS: perfectGas\n\tgamma: 1.4\n\tRgas: 287\n\tspecies: O2, N2\nEOS: perfectGas\n\tgamma: 3.2\n\tRgas: 100.2\n\tspecies: CO2, CO\n"}),
...
INSTANTIATE_TEST_SUITE_P(StiffenedGasEOSTests, TPThermodynamicPropertyTestFixture,
                         testing::Values((TPTestParameters){.eos1 = std::make_shared<ablate::eos::PerfectGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "1.4"}, {"Rgas", "287.0"}})),
                                         ...
                                         (TPTestParameters){.eos1 = std::make_shared<ablate::eos::PerfectGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "1.4"}, {"Rgas", "287.0"}}), std::vector<std::string>{"CO2"}),
                                                            .eos2 = std::make_shared<ablate::eos::PerfectGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "3.2"}, {"Rgas", "100.2"}}), std::vector<std::string>{"O2", "CH4", "N2"}),
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ...
        (TPFieldFunctionTestParameters){.eos1 = std::make_shared<ablate::eos::PerfectGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "1.4"}, {"Rgas", "287.0"}}), std::vector<std::string>{"CO2"}),
                                        .eos2 = std::make_shared<ablate::eos::PerfectGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "3.2"}, {"Rgas", "100.2"}}), std::vector<std::string>{"O2", "CH4", "N2"}),
                                        .field = "densityYi",
                                        .property1 = ablate::eos::ThermodynamicProperty::Temperature,
                                        .property2 = ablate::eos::ThermodynamicProperty::Pressure,
        ...
        (TPFieldFunctionTestParameters){.eos1 = std::make_shared<ablate::eos::PerfectGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "1.43"}, {"Rgas", "106.4"}})),
                                        .eos2 = std::make_shared<ablate::eos::StiffenedGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "2.31015"}, {"Cp","4643.4015"}, {"p0","6.0695E8"}})),
                                        .field = "euler",
                                        .property1 = ablate::eos::ThermodynamicProperty::Temperature,
                                        .property2 = ablate::eos::ThermodynamicProperty::Pressure,
        ...
        (TPFieldFunctionTestParameters){.eos1 = std::make_shared<ablate::eos::PerfectGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "1.43"}, {"Rgas", "106.4"}}), std::vector<std::string>{"CO2"}),
                                        .eos2 = std::make_shared<ablate::eos::StiffenedGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "2.31015"}, {"Cp","4643.4015"}, {"p0","6.0695E8"}}), std::vector<std::string>{"O2","N2","H2"}),
                                        .field = "densityYi",
                                        .property1 = ablate::eos::ThermodynamicProperty::Temperature,
                                        .property2 = ablate::eos::ThermodynamicProperty::Pressure,
                                        .property1Value = 600.0,
        ...
        (TPFieldFunctionTestParameters){.eos1 = std::make_shared<ablate::eos::StiffenedGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "2.31015"}, {"Cp","4643.4015"}, {"p0","6.0695E8"}})),
                                        .eos2 = std::make_shared<ablate::eos::StiffenedGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "1.932"}, {"Cp","8095.08"}, {"p0","1.1645E9"}})),
                                        .field = "euler",
        ...
        (TPFieldFunctionTestParameters){.eos1 = std::make_shared<ablate::eos::StiffenedGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "2.31015"}, {"Cp","4643.4015"}, {"p0","6.0695E8"}}), std::vector<std::string>{"H2","O2"}),
                                        .eos2 = std::make_shared<ablate::eos::StiffenedGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "1.932"}, {"Cp","8095.08"}, {"p0","1.1645E9"}}), std::vector<std::string>{"N2"}),
                                        .field = "densityYi",
                                        .property1 = ablate::eos::ThermodynamicProperty::Pressure,
                                        .property2 = ablate::eos::ThermodynamicProperty::Temperature,
                                        .property1Value = 100000.0,
        ...
        (TPFieldFunctionTestParameters){.eos1 = std::make_shared<ablate::eos::PerfectGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "1.43"}, {"Rgas", "106.4"}}), std::vector<std::string>{"H2","O2"}),
                                        .eos2 = std::make_shared<ablate::eos::StiffenedGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "2.31015"}, {"Cp","4643.4015"}, {"p0","6.0695E8"}}), std::vector<std::string>{"N2"}),
                                        .field = "densityYi",
                                        .property1 = ablate::eos::ThermodynamicProperty::Pressure,
                                        .property2 = ablate::eos::ThermodynamicProperty::InternalSensibleEnergy,
                                        .property1Value = 100000.0,
        ...
        (TPFieldFunctionTestParameters){.eos1 = std::make_shared<ablate::eos::PerfectGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "1.4"}, {"Rgas", "287.0"}}), std::vector<std::string>{"H2","O2"}),
                                        .eos2 = std::make_shared<ablate::eos::PerfectGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "1.43"}, {"Rgas", "106.4"}}), std::vector<std::string>{"N2"}),
                                        .field = "densityYi",
                                        .property1 = ablate::eos::ThermodynamicProperty::InternalSensibleEnergy,
                                        .property2 = ablate::eos::ThermodynamicProperty::Pressure,
                                        .property1Value = 124627.50601443468,
