...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ...
        (TChemSootCreateAndViewParameters){.mechFile = "inputs/eos/gri30.yaml", .expectedViewStart = "EOS: TChemSoot\n\tmechFile: \"inputs/eos/gri30.yaml\"\n\tnumberSpecies: 54\n"}),
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        (TChemSootTestParameters){
            .mechFile = "inputs/eos/grimech30.dat",
            .thermoFile = "inputs/eos/thermo30.dat",
            .fields = {ablate::domain::Field{.name = "euler", .numberComponents = 5, .offset = 0}, ablate::domain::Field{.name = "densityYi", .numberComponents = 54, .offset = 5}},
        ...
        (TChemSootTestParameters){
            .mechFile = "inputs/eos/grimech30.dat",
            .thermoFile = "inputs/eos/thermo30.dat",
            .fields = {ablate::domain::Field{.name = "euler", .numberComponents = 5, .offset = 2}, ablate::domain::Field{.name = "densityYi", .numberComponents = 54, .offset = 7}},
            .conservedEulerValues = {1.2, 1.2 * 1.0E+05, 1.2 * 10, -1.2 * 20, 1.2 * 30},
            .yiMap = {{"CH4", .2}, {"O2", .3}, {"N2", .5}},
            .expectedTemperature = 499.2577,
            .testProperties = {{ablate::eos::ThermodynamicProperty::Temperature, {499.2577}},
        ...
        (TChemSootTestParameters){
            .mechFile = "inputs/eos/grimech30.dat",
            .thermoFile = "inputs/eos/thermo30.dat",
            .fields = {ablate::domain::Field{.name = "euler", .numberComponents = 5, .offset = 54}, ablate::domain::Field{.name = "densityYi", .numberComponents = 54, .offset = 0}},
            .conservedEulerValues = {1.2, 1.2 * 1.0E+05, 1.2 * 10, -1.2 * 20, 1.2 * 30},
            .yiMap = {{"CH4", .2}, {"O2", .3}, {"N2", .5}},
            .expectedTemperature = 499.2577,
            .testProperties = {{ablate::eos::ThermodynamicProperty::Temperature, {499.2577}},
        ...
        (TChemSootTestParameters){
            .mechFile = "inputs/eos/grimech30.dat",
            .thermoFile = "inputs/eos/thermo30.dat",
            .fields = {ablate::domain::Field{.name = "euler", .numberComponents = 3, .offset = 54}, ablate::domain::Field{.name = "densityYi", .numberComponents = 54, .offset = 0}},
        ...
        (TChemSootTestParameters){
            .mechFile = "inputs/eos/grimech30.dat",
            .thermoFile = "inputs/eos/thermo30.dat",
            .fields = {ablate::domain::Field{.name = "euler", .numberComponents = 5, .offset = 56}, ablate::domain::Field{.name = "densityYi", .numberComponents = 54, .offset = 2}},
        ...
        (TChemSootTestParameters){
            .mechFile = "inputs/eos/grimech30.dat",
            .thermoFile = "inputs/eos/thermo30.dat",
            .fields = {ablate::domain::Field{.name = "euler", .numberComponents = 3, .offset = 0}, ablate::domain::Field{.name = "densityYi", .numberComponents = 54, .offset = 3}},
