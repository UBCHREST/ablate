...
INSTANTIATE_TEST_SUITE_P(TChemSootTests, TChemSootCreateAndViewFixture,
                         testing::Values((TChemSootCreateAndViewParameters){.mechFile = "inputs/eos/gri30.yaml",
                                                                            .expectedViewStart = "EOS: TChemSoot\n\tmechFile: \"inputs/eos/gri30.yaml\"\n\tnumberSpecies: 54\n"}),
                         [](const testing::TestParamInfo<TChemSootCreateAndViewParameters>& info) { return testingResources::PetscTestFixture::SanitizeTestName(info.param.mechFile.string()); });
...
INSTANTIATE_TEST_SUITE_P(TChemSootTests, TChemSootGetSpeciesFixture,
                         testing::Values((TChemSootGetSpeciesParameters){
                             .mechFile = "inputs/eos/gri30.yaml",
                         ...
                         [](const testing::TestParamInfo<TChemSootGetSpeciesParameters>& info) { return testingResources::PetscTestFixture::SanitizeTestName(info.param.mechFile.string()); });
...
TEST_P(TChemSootElementTestFixture, ShouldDetermineElements) {
    ONLY_WITH_CUDA_CHECK
    // arrange
    auto eos = std::make_shared<ablate::eos::TChemSoot>(GetParam().mechFile);
...
INSTANTIATE_TEST_SUITE_P(TChemTests, TChemSootElementTestFixture,
                         testing::Values((TChemSootElementTestParameters){.mechFile = "inputs/eos/gri30.yaml",
...
INSTANTIATE_TEST_SUITE_P(TChemTests, TChemSootComputeSourceTestFixture,
                         testing::Values((TChemSootComputeSourceTestParameters){
                             .mechFile = "inputs/eos/gri30.yaml",
