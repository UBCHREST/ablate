...
INSTANTIATE_TEST_SUITE_P(
    StiffenedGasEOSTests, StiffenedGasTestCreateAndViewFixture,
    testing::Values((StiffenedGasEOSTestCreateAndViewParameters){.options = {}, .species = {}, .expectedView = "EOS: stiffenedGas\n\tgamma: 1.932\n\tCp: 8095.08\n\tp0: 1.1645e+09\n"},
                    (StiffenedGasEOSTestCreateAndViewParameters){
                        .options = {{"gamma", "3.2"}, {"Cp", "100.2"}, {"p0", "3.5e6"}}, .species = {}, .expectedView = "EOS: stiffenedGas\n\tgamma: 3.2\n\tCp: 100.2\n\tp0: 3.5e+06\n"},
