...
INSTANTIATE_TEST_SUITE_P(
    RadationSootTests, SootSpectrumTestFixture,
    testing::Values(/** A test with all valid species for the Soot model */
                    (SootSpectrumTestParameters){.fields = {ablateTesting::domain::MockField::Create("euler", 5), ablateTesting::domain::MockField::Create("densityYi", {"C(S)"}, 5)},
                    ...
                    (SootSpectrumTestParameters){.fields = {ablateTesting::domain::MockField::Create("euler", 5, 0), ablateTesting::domain::MockField::Create("densityYi", {"C(S)"}, 5)},
                    ...
                    (SootSpectrumTestParameters){.fields = {ablateTesting::domain::MockField::Create("euler", 1, 0), ablateTesting::domain::MockField::Create("densityYi", {"C(S)", "A", "B", "C"}, 5)},
