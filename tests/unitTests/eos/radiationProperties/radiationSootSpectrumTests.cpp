...
TEST_P(SootSpectrumTestFixture, ShouldProduceExpectedValuesForField) {
    ...
    auto sootModel = std::make_shared<ablate::eos::radiationProperties::SootSpectrumProperties>(eos, 0, 0, 0, wavelengths, bandwidths);  //!< An instantiation of the Zimmer model (with options set to nullptr)
