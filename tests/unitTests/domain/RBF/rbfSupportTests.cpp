...
INSTANTIATE_TEST_SUITE_P(MeshTests, RBFSupportTestFixture_ReturnID,
                         testing::Values((RBFSupportParameters_ReturnID){.mpiTestParameter = {.testName = "2DQuad", .nproc = 1},
                                         ...
                                         (RBFSupportParameters_ReturnID){
                                             .mpiTestParameter = {.testName = "2DQuadMPIMod", .nproc = 2},  // This is mainly here to check if there is ever a change in how DMLocatePoints functions
                                             .meshFaces = {10, 10},
                                             .meshStart = {0.0, 0.0},
                                             .meshEnd = {1.0, 1.0},
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        (RBFSupportParameters_NeighborCells){.mpiTestParameter = {.testName = "2DQuadVert", .nproc = 1},
                                             .meshFaces = {10, 10},
                                             .meshStart = {0.0, 0.0},
                                             .meshEnd = {1.0, 1.0},
                                             .meshModifiers = {},
