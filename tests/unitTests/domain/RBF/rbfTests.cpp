...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ...
        (RBFParameters_DerivativeInterpolation){.mpiTestParameter = {.testName = "3DQuadN41_1Proc"},
                                                ...
                                                .dz = {0, 0, 0, 0, 0, 0, 1, 1, 1, 2},
                                                .cell = 0,
                                                .maxError = {2.1e-15, 1.1e-03, 8.9e-02, 1.1e-03, 1.7e-04, 8.9e-02, 1.1e-03, 1.7e-04, 1.9e-04, 8.9e-02}},
        (RBFParameters_DerivativeInterpolation){.mpiTestParameter = {.testName = "3DTriN21_1Proc"},
                                                ...
                                                .dz = {0, 0, 0, 0, 0, 0, 1, 1, 1, 2},
                                                .cell = 0,
                                                .maxError = {2.3e-16, 3.5e-05, 3.5e-03, 5.6e-05, 1.7e-04, 3.0e-03, 1.51e-04, 6.3e-03, 5.9e-03, 2.1e-03}},
