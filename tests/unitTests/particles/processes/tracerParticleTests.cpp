...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values((TracerParticleMMSParameters){.mpiTestParameter = testingResources::MpiTestParameter(
                                                      ...
                                                      std::make_shared<testingResources::asserts::StdOutAssert>("outputs/particles/tracerParticles_incompressible_trigonometric_2d_tri_p2_p1_p1")),
                                                  .uExact = trig_trig_u,
                                                  .pExact = trig_trig_p,
                                                  .TExact = trig_trig_T,
                                                  ...
                                                  .f0_q = nullptr,
                                                  .omega = 0.5},
                    (TracerParticleMMSParameters){.mpiTestParameter = testingResources::MpiTestParameter(
                                                      "particle deletion with simple fluid tri_p2_p1_p1", 1,
                                                      ...
                                                      std::make_shared<testingResources::asserts::StdOutAssert>("outputs/particles/tracerParticles_deletion_with_simple_fluid_tri_p2_p1_p1")),
                                                  .uExact = linear_u,
                                                  .pExact = linear_p,
                                                  .TExact = linear_T,
