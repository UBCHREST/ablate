...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
struct LinearFunctionTestsParameters {
    std::shared_ptr<ablate::mathFunctions::MathFunction> startFunction;
    std::shared_ptr<ablate::mathFunctions::MathFunction> endFunction;
    double start;
    double end;
    int dir;
...
class LinearFunctionTestsFixture : public ::testing::TestWithParam<LinearFunctionTestsParameters> {};

TEST_P(LinearFunctionTestsFixture, ShouldEvalToScalarFromXYZ) {
    // arrange
    auto& params = GetParam();
    auto function = ablate::mathFunctions::LinearFunction(params.startFunction, params.endFunction, params.start, params.end, params.dir);
...
TEST_P(LinearFunctionTestsFixture, ShouldEvalToScalarFromCoord) {
    // arrange
    auto& params = GetParam();
    auto function = ablate::mathFunctions::LinearFunction(params.startFunction, params.endFunction, params.start, params.end, params.dir);
...
TEST_P(LinearFunctionTestsFixture, ShouldEvalToVectorFromXYZ) {
    // arrange
    auto& params = GetParam();
    auto function = ablate::mathFunctions::LinearFunction(params.startFunction, params.endFunction, params.start, params.end, params.dir);
...
TEST_P(LinearFunctionTestsFixture, ShouldEvalToVectorFromCoord) {
    // arrange
    auto& params = GetParam();
    auto function = ablate::mathFunctions::LinearFunction(params.startFunction, params.endFunction, params.start, params.end, params.dir);
...
TEST_P(LinearFunctionTestsFixture, ShouldProvideAndFunctionWithPetscFunction) {
    // arrange
    auto& params = GetParam();
    auto function = std::make_shared<ablate::mathFunctions::LinearFunction>(params.startFunction, params.endFunction, params.start, params.end, params.dir);
...
INSTANTIATE_TEST_SUITE_P(LinearTests, LinearFunctionTestsFixture,
                         testing::Values((LinearFunctionTestsParameters){.startFunction = ablate::mathFunctions::Create({0.0, 10.0, -20.0}),
                                                                         .endFunction = ablate::mathFunctions::Create({1, -10, 20}),
                                                                         .start = 0.0,
                                                                         .end = 1.0,
                                                                         .dir = 0,
                                                                         .testValues =
                                         ...
                                         (LinearFunctionTestsParameters){.startFunction = ablate::mathFunctions::Create({0, 10, -20}),
                                                                         .endFunction = ablate::mathFunctions::Create({1, -10, 20}),
                                                                         .start = 1,
                                                                         .end = 1.5,
                                                                         .dir = 1,
                         ...
                         [](const testing::TestParamInfo<LinearFunctionTestsParameters>& info) { return "linearFunctionTest" + std::to_string(info.index); });
