...
TEST_P(RadiationTestFixture, ShouldComputeCorrectSourceTerm) {
    StartWithMPI
        ...
        auto radiation =
            std::make_shared<ablate::radiation::VolumeRadiation>("radiation", ablate::domain::Region::ENTIREDOMAIN, ablate::domain::Region::ENTIREDOMAIN, 15, nullptr, nullptr, radiationModel, nullptr);
