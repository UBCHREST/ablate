...
TEST(RunEnvironmentTest, ShouldReturnCorrectParameterFromRunEnvironmentParameters) {
    ...
    auto parameters1 = ablate::environment::RunEnvironment::Parameters().TagDirectory(false).OutputDirectory("/path/to/output/directory");
    auto parameters2 = ablate::environment::RunEnvironment::Parameters().TagDirectory(true).Title("test123");
    ...
    ASSERT_EQ(parameters2.GetExpect<std::string>("title"), "test123");
}
