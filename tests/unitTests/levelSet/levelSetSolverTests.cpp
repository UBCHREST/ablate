...
TEST_P(LevelSetTestFixture, CheckLSFunctions) {
    ...
    //        std::make_shared<ablate::domain::FieldDescription>(ablate::levelSet::LevelSetFields::LEVELSET_FIELD, "", ablate::domain::FieldDescription::ONECOMPONENT,
    //        ablate::domain::FieldLocation::AUX, ablate::domain::FieldType::FVM), std::make_shared<ablate::domain::FieldDescription>(ablate::levelSet::LevelSetFields::CURVATURE_FIELD, "",
    //        std::vector<std::string>{ablate::levelSet::LevelSetFields::NORMAL_FIELD + ablate::domain::FieldDescription::DIMENSION}, ablate::domain::FieldLocation::AUX,
    //        ablate::domain::FieldType::FVM), std::make_shared<ablate::domain::FieldDescription>(ablate::levelSet::LevelSetFields::NORMAL_FIELD, "", ablate::domain::FieldDescription::ONECOMPONENT,
    //        ablate::domain::FieldLocation::AUX, ablate::domain::FieldType::FVM),
    //    };
    ...
    //    auto mesh = std::make_shared<domain::BoxMesh>("mesh", fieldDescriptor,
...
//             .expectedDerivatives =
//                 {1.0 / exp(6.0), 1.0 / exp(6.0), 0.5 / exp(6.0), 2.0 / exp(6.0), 3.5 / exp(6.0), 2.0 / exp(6.0), -1.0 / exp(6.0), 0.5 / exp(6.0), -1.0 / exp(6.0), -2.0 / exp(6.0), -2.0 /
//                 exp(6.0)}},
