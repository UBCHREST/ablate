...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ...
        MpiTestParameter("inputs/reactingFlow/ignitionDelayGriMechConstantVolumeReactor.yaml", 1, "", "",
                         {{"outputs/reactingFlow/ignitionDelayGriMechConstantVolumeReactor.PeakYi.txt", "ignitionDelayPeakYi.txt"},
