...
IntegrationRestartTestFixture::IntegrationRestartTestFixture(std::shared_ptr<testingResources::MpiTestParameter> mpiTestParameter, std::string restartInputFile,
    ...
    : IntegrationTestFixture(std::move(mpiTestParameter)), restartInputFile(std::move(restartInputFile)), restartOverrides(std::move(restartOverrides)) {}
...
REGISTER(IntegrationTestFixture, IntegrationRestartTest, "Runs the basic ABLATE integration test", ARG(testingResources::MpiTestParameter, "testParameters", "the basic mpi test parameters"),
         OPT(std::string, "restartInputFile", "optional other input file to use upon restart"), OPT(ablate::parameters::Parameters, "restartOverrides", "overrides for the input file upon restart"));
