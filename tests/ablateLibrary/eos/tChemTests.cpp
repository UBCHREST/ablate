...
INSTANTIATE_TEST_SUITE_P(TChemTests, TCThermodynamicPropertyTestFixture,
                         testing::Values((TCTestParameters){.mechFile = "inputs/eos/grimech30.dat",
                                                            .thermoFile = "inputs/eos/thermo30.dat",
                                                            .fields = {ablate::domain::Field{.name = "euler", .numberComponents = 5, .offset = 0},
                                                                       ablate::domain::Field{.name = "densityYi", .numberComponents = 53, .offset = 5}},
                                         ...
                                         (TCTestParameters){.mechFile = "inputs/eos/grimech30.dat",
                                                            ...
                                                            .fields = {ablate::domain::Field{.name = "euler", .numberComponents = 5, .offset = 2},
                                                                       ablate::domain::Field{.name = "densityYi", .numberComponents = 53, .offset = 7}},
                                                            .conservedEulerValues = {1.2, 1.2 * 1.0E+05, 1.2 * 10, -1.2 * 20, 1.2 * 30},
                                                            .yiMap = {{"CH4", .2}, {"O2", .3}, {"N2", .5}},
                                                            .expectedTemperature = 499.2577,
                                                            .testProperties = {{ablate::eos::ThermodynamicProperty::Temperature, {499.2577}},
                                         ...
                                         (TCTestParameters){.mechFile = "inputs/eos/grimech30.dat",
                                                            .thermoFile = "inputs/eos/thermo30.dat",
                                                            .fields = {ablate::domain::Field{.name = "euler", .numberComponents = 5, .offset = 53},
                                                                       ablate::domain::Field{.name = "densityYi", .numberComponents = 53, .offset = 0}},
                                                            .conservedEulerValues = {1.2, 1.2 * 1.0E+05, 1.2 * 10, -1.2 * 20, 1.2 * 30},
                                                            .yiMap = {{"CH4", .2}, {"O2", .3}, {"N2", .5}},
                                                            .expectedTemperature = 499.2577,
                                                            .testProperties = {{ablate::eos::ThermodynamicProperty::Temperature, {499.2577}},
                                         ...
                                         (TCTestParameters){.mechFile = "inputs/eos/grimech30.dat",
                                                            .thermoFile = "inputs/eos/thermo30.dat",
                                                            .fields = {ablate::domain::Field{.name = "euler", .numberComponents = 3, .offset = 53},
                                                                       ablate::domain::Field{.name = "densityYi", .numberComponents = 53, .offset = 0}},
                                         ...
                                         (TCTestParameters){.mechFile = "inputs/eos/grimech30.dat",
                                                            .thermoFile = "inputs/eos/thermo30.dat",
                                                            .fields = {ablate::domain::Field{.name = "euler", .numberComponents = 5, .offset = 55},
                                                                       ablate::domain::Field{.name = "densityYi", .numberComponents = 53, .offset = 2}},
