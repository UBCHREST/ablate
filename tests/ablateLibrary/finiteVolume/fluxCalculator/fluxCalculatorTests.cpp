...
//        },
        ...
        (FluxCalculatorTestParameters){
            .testName = "RiemannStiffFluxT4",
            .fluxCalculator = std::make_shared<ablate::finiteVolume::fluxCalculator::RiemannStiff>(
                std::make_shared<ablate::eos::StiffenedGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "1.932"},{"Cp","8095.08"},{"p0","1.1645e9"}})),
                std::make_shared<ablate::eos::PerfectGas>(std::make_shared<ablate::parameters::MapParameters>(std::map<std::string, std::string>{{"gamma", "1.4"}}))),
            .uL = {0.0},//, -2.0, 0.0, 0.0, 19.5975},
            .aL = {2044.9484101072085},//, 0.816578, 40.828911, 0.12911235, 11.3167106},  // gam=1.667 a = \gam * p / \rho
            .rhoL = {1000.0},// 1.0, 1.0, 1.0, 5.99924},
            .pL = {1000000000.0},// 0.4, 1000.0, 0.01, 460.894},
            .uR = {0.0},// 2.0, 0.0, 0.0, -6.19633},
            .aR = {52.91502622129181},// 0.74833148, 0.1183216, 11.8321596, 3.28163145},  // gam=1.4 a = \gam * p / \rho
            .rhoR = {50},// 1.0, 1.0, 1.0, 5.99242},
            .pR = {100000.0},// 0.4, 0.01, 100.0, 46.0950},
            .expectedMassFlux = {434205.19124982634},// -0.005215, 11.4486735, -3.5061155, 112.3130},                // status at x =0
            .expectedInterfacePressure = {21306365.4962665},// 0.000676, 430.992964, 47.5230682, 1758.5562536},  // pressure at x=0
            .expectedDirection = {LEFT}//, RIGHT, LEFT, RIGHT, LEFT}                                       // Upwind direction based on velocity at x = 0
        },
        // Riemann2Gas flux testing, same gamma L/R
        (FluxCalculatorTestParameters){
