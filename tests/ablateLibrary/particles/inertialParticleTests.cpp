    ...
    StartWithMPI
        {
            ...
            auto particles = std::make_shared<ablate::particles::ParticleSolver>(
                ...
                particleOptions,
                std::vector<ablate::particles::FieldDescription>{{.name = ablate::particles::ParticleSolver::ParticleVelocity, .components = {"u", "v"}, .type = domain::FieldLocation::SOL},
                                                                 {.name = ablate::particles::ParticleSolver::ParticleDiameter, .type = domain::FieldLocation::AUX},
                                                                 {.name = ablate::particles::ParticleSolver::ParticleDensity, .type = domain::FieldLocation::AUX}},
