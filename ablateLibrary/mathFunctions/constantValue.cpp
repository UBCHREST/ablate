...
double ablate::mathFunctions::ConstantValue::Eval(const double &x, const double &y, const double &z, const double &t) const {
    return value[0];
}
double ablate::mathFunctions::ConstantValue::Eval(const double *xyz, const int &ndims, const double &t) const {
    return value[0];}
