...
#define REGISTER_PASS_THROUGH(interfaceTypeFullName, classFullName, description, argumentType)                                                                             \
    template <>                                                                                                                                                            \
    bool ablate::parser::RegisteredInFactory<interfaceTypeFullName, classFullName>::Registered =                                                                           \
        ablate::parser::Registrar<interfaceTypeFullName>::Register<classFullName>(false, #classFullName, description, ablate::parser::ArgumentIdentifier<argumentType>{}); \
    RESOLVE(interfaceTypeFullName, classFullName)

#define REGISTERDEFAULT_PASS_THROUGH(interfaceTypeFullName, classFullName, description, argumentType)                                                                     \
    template <>                                                                                                                                                           \
    bool ablate::parser::RegisteredInFactory<interfaceTypeFullName, classFullName>::Registered =                                                                          \
        ablate::parser::Registrar<interfaceTypeFullName>::Register<classFullName>(true, #classFullName, description, ablate::parser::ArgumentIdentifier<argumentType>{}); \
    RESOLVE(interfaceTypeFullName, classFullName)
