...
ablate::flow::fluxDifferencer::Direction ablate::flow::fluxDifferencer::OffFluxDifferencer::OffDifferencerFunction(void*, PetscReal uL, PetscReal aL, PetscReal rhoL, PetscReal pL,
