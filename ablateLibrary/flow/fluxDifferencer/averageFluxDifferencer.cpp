...
REGISTER_WITHOUT_ARGUMENTS(ablate::flow::fluxDifferencer::FluxDifferencer, ablate::flow::fluxDifferencer::AverageFluxDifferencer, "Takes the average of the left/right faces.  Only useful for debugging.");