...
ablate::flow::boundaryConditions::EssentialGhost::EssentialGhost(std::string fieldName, std::string boundaryName, std::vector<int> labelIds,
                                                                 std::shared_ptr<mathFunctions::MathFunction> boundaryFunction, std::string labelName)
    : Ghost(fieldName, boundaryName, labelIds, EssentialGhostUpdate, this, labelName), boundaryFunction(boundaryFunction) {}
