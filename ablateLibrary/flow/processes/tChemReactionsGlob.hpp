#ifndef ABLATELIBRARY_TCHEMREACTIONSGLOB_HPP
#define ABLATELIBRARY_TCHEMREACTIONSGLOB_HPP
...
class TChemReactionsGlob : public FlowProcess {
   private:
    DM fieldDm;
    Vec sourceVec;
    ...
    inline const static PetscReal dtInitDefault = 1E-4;
   ...
   public:
    explicit TChemReactionsGlob(std::shared_ptr<eos::EOS> eos, std::shared_ptr<parameters::Parameters> options = {});
    ~TChemReactionsGlob() override;
    /**
