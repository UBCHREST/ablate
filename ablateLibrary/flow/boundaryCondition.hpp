...
class BoundaryCondition {
   ...
   public:
    BoundaryCondition(std::string fieldName, std::string boundaryName, std::string labelName, int labelId, std::shared_ptr<mathFunctions::MathFunction> boundaryValue,
    ...
    const int& GetLabelId() const { return labelId; }

    const int& GetBCType() const { return bcType; }
