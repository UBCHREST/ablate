...
class TwoPhaseEulerAdvection : public Process {
   private:
    ...
    class PerfectGasPerfectGasDecoder : public TwoPhaseDecoder {
       ...
       public:
        PerfectGasPerfectGasDecoder(PetscInt dim, std::shared_ptr<eos::PerfectGas> perfectGasEos1, std::shared_ptr<eos::PerfectGas> perfectGasEos2);
    ...
    class PerfectGasStiffenedGasDecoder : public TwoPhaseDecoder {
       ...
       public:
        PerfectGasStiffenedGasDecoder(PetscInt dim, std::shared_ptr<eos::PerfectGas> perfectGasEos1, std::shared_ptr<eos::StiffenedGas> perfectGasEos2);
