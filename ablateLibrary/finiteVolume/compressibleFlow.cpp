                   ...
                   utilities::VectorUtilities::Merge(
                       {
                           ...
                           std::make_shared<ablate::finiteVolume::processes::EVTransport>(finiteVolume::CompressibleFlowFields::DENSITY_EV_FIELD, finiteVolume::CompressibleFlowFields::EV_FIELD, eosIn,
                                                                                          fluxCalculatorIn, transport),
                       },
                       additionalProcesses),
