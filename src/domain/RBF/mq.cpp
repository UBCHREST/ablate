...
MQ::MQ(int p, double scale, bool doesNotHaveDerivatives, bool doesNotHaveInterpolation)
    : RBF(p, !doesNotHaveDerivatives, !doesNotHaveInterpolation), scale(scale < PETSC_SMALL ? __RBF_MQ_DEFAULT_PARAM : scale){};
