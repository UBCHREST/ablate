...
void ablate::radiation::SurfaceRadiation::Initialize(const ablate::domain::Range& cellRange, ablate::domain::SubDomain& subDomain) { /** Declare some information associated with the field declarations */
