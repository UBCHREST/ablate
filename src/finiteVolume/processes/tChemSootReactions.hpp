...
class TChemSootReactions : public Process {
   private:
   ...
   public:
    explicit TChemSootReactions(const std::shared_ptr<eos::EOS> &eos, const std::shared_ptr<ablate::parameters::Parameters> &options = {});
    ~TChemSootReactions() override;
    /**
