...
class LesCompressibleFlowSolver : public FiniteVolumeSolver {
   public:
    /**
     ...
     */
    LesCompressibleFlowSolver(std::string solverId, std::shared_ptr<domain::Region> region, std::shared_ptr<parameters::Parameters> options, const std::shared_ptr<eos::EOS>& eos,
    ...
    LesCompressibleFlowSolver(std::string solverId, std::shared_ptr<domain::Region> region, std::shared_ptr<parameters::Parameters> options, const std::shared_ptr<eos::EOS>& eos,
                              ...
                              bool computePhysicsTimeStep = false);
    ~LesCompressibleFlowSolver() override = default;
};
}  // namespace ablate::finiteVolume
