...
[[maybe_unused]] void ablate::eos::tChemSoot::Temperature::runDeviceBatch(typename UseThisTeamPolicy<exec_space>::type& policy,
                                                                          const Temperature::real_type_2d_view_type& state,
                                                                          const Temperature::real_type_1d_view_type& internalEnergyRef,
                                                                          const Temperature::real_type_2d_view_type& enthalpyMass,
                                                                          const Temperature::real_type_1d_view_type& enthalpyReference,
...
[[maybe_unused]] void ablate::eos::tChemSoot::Temperature::runHostBatch(const typename UseThisTeamPolicy<host_exec_space>::type& policy,
                                                                        ...
                                                                        const Temperature::real_type_2d_view_host_type& enthalpyMass,
                                                                        const Temperature::real_type_1d_view_host_type& enthalpyReference,
