#ifndef ABLATELIBRARY_TCHEM2_HPP
#define ABLATELIBRARY_TCHEM2_HPP
...
#include "eos.hpp"
#include "eos/tChem2/pressure.hpp"
#include "eos/tChem2/sensibleEnthalpy.hpp"
#include "eos/tChem2/sensibleInternalEnergy.hpp"
#include "eos/tChem2/sourceCalculator2.hpp"
#include "eos/tChem2/speedOfSound.hpp"
#include "eos/tChem2/temperature.hpp"
...
class TChem2 : public TChemBase, public std::enable_shared_from_this<ablate::eos::TChem2> {
   public:
    /**
   ...
   public:
     ...
     */
    explicit TChem2(std::filesystem::path mechanismFile, std::filesystem::path reactionFileIn, std::filesystem::path thermoFileIn, std::shared_ptr<ablate::monitors::logs::Log> = {}, const std::shared_ptr<ablate::parameters::Parameters>& options = {});
