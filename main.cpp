...
#include "parser/testFactory.hpp"
...
int main(int argc, char **args) {
   std::shared_ptr< ablate::parser::Factory> factory = std::make_shared< ablate::parser::TestFactory>("Blue");

    auto value =factory->Get(ablate::parser::ArgumentIdentifier<ITalky>{.inputName = "Blue"});
...
//        //
//        // -vel_petscspace_degree 2 -pres_petscspace_degree 1 -temp_petscspace_degree 1  -ksp_type fgmres -ksp_gmres_restart 10 -ksp_rtol 1.0e-9 -ksp_atol 1.0e-14 -ksp_error_if_not_converged -pc_type
